...
object AppSettings {
    ...
    fun setup(context: Context) {
        prefs = context.getSharedPreferences("sayit_settings", Context.MODE_PRIVATE)
    }
    ...
    val ballSize: Int get() = getInt("ball_size", 50)
    val overlayAlways: Boolean get() = getBool("overlay_always", true)
    val customBallUri: String? get() = prefs?.getString("custom_ball_uri", null)
}
